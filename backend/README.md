...
Demo (3 мин) выдаётся автоматически, один раз на Telegram-аккаунт — к сообщению
приклеена кнопка перехода к Standard, чтобы демо не заканчивалось тупиком, когда
минуты кончатся. Standard (60 мин/30 дней) — полу-авто: клиент жмёт «Я оплатил»
