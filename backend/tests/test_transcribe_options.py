...
def test_defaults_favour_completeness_over_filtering():
    """Пороги мягче штатных — так измеренно лучше.

    Замер 2026-07-28 на казахском ролике: WER 35.65 % с мягкими порогами против
    36.52 % со штатными и 37.39 % вообще без порогов. То есть отсев нужен, но
    английская калибровка на казахском слишком строга. Средства против
    галлюцинаций, которые ничего не удаляют (condition_on_previous_text=false,
    порог сжимаемости), остаются включёнными.
    """
    opts = decode_options()
